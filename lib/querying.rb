...
def select_value_and_count_of_most_prolific_species
  "SELECT characters.species, COUNT(characters.species) FROM characters GROUP BY characters.species HAVING COUNT(characters.species) = (SELECT MAX(mycount) FROM (SELECT characters.species, COUNT(characters.species) mycount FROM characters GROUP BY characters.species))"
end
